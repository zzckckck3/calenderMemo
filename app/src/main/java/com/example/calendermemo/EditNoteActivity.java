...
public class EditNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // set theme
        SharedPreferences sharedPreferences = getSharedPreferences(MemoActivity.APP_PREFERENCES, Context.MODE_PRIVATE);
        int theme = sharedPreferences.getInt(MemoActivity.THEME_Key, R.style.AppTheme);
        setTheme(theme);
